...
// Function prototypes
void increment_watched(Movies&, std::string);
void add_movie(Movies&, std::string, std::string, int);

/**
 * @brief Test the Movies project
 *
 */
void s13c_run(void)
{
...
/**
 * @brief increment_watched expects a reference to a Movies object
...
/**
 * @brief add_movie expects a reference to a Movies object
